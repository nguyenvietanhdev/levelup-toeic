/**
 * Hoàn tác normalize-upload-type.js — trả `type` về nhãn tiếng Anh ban đầu.
 *
 * Dùng:
 *   node scripts/restore-upload-type.js backup-upload-type-....json
 */
...
if (!file) {
    console.error('Thiếu tên file backup.\nVí dụ: node scripts/restore-upload-type.js backup-upload-type-....json');
    process.exit(1);
}
